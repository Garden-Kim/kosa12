...
고객 연락처1 : <input type="tel" name="memPhone1" value="${memberDTO.memPhone1 }"> <br>
고객 연락처2 : <input type="tel" name="memPhone2" value="${memberDTO.memPhone2 }"> <br>
고객 주소 : <input type="text" name="memAddr" value="${memberDTO.memAddr }"> <br>
고객 이메일 : <input type="text" name="memEmail" value="${memberDTO.memEmail }"> <br>
성별 : <input type="radio" name="memGender" value="M" <c:if test="${memberDTO.memGender=='M' }">checked</c:if>>남자
	  <input type="radio" name="memGender" value="F" <c:if test="${memberDTO.memGender=='F' }">checked</c:if>>여자 <br>
