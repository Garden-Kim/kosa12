...
고객 번호 : <input type="text" name="memNum" readonly="readonly" value="kosa${memberNum }" required="required">: 번호 자동부여<br>
...
고객 성별 : <input type="radio" name="memGender" value="F" checked="checked"/>여자
...
고객 비밀번호 : <input type="password" name="memPw" required="required" id="memPw"><br>
...
고객 이메일 : <input type="text" name="memEmail"><br>
