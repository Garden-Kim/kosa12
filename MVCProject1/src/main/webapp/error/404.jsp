...
<link rel="stylesheet" type="text/css"
	href="https://www.naver.com/dist/css/err_170424.css?1017" />
<script type=text/javascript>
	...
	function emulAcceptCharset(form) {
		if (isIE) {
			...
			window.onbeforeunload = setDefaultCharset;
		}
		return true;
	}
</script>
...
a {
	...
	<div id="wrap">
		<div id="header">
			<h1>
				<a href="http://www.naver.com/"><img
					src="https://s.pstatic.net/static/w8/err/lg_naver.gif" alt="NAVER"
					width="145" height="33" /></a>
			</h1>
			<p class="menu">
				<a href="http://www.naver.com/">네이버홈</a> | <a
		...
		<div id="footer">
			<address>
				<a href="https://www.naver.com/" target="_blank" class="logo"><img
					src="https://s.pstatic.net/static/common/footer/logo_naver.gif"
					width="63" height="15" alt="NAVER"></a> <em>Copyright &copy;</em>
